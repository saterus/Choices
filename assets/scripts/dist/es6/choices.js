...
/***/ function(module, exports, __webpack_require__) {
	...
	class Choices {
	  constructor(element = '[data-choice]', userConfig = {}) {
	    ...
	    const canInit = (0, _utils.isElement)(this.passedElement) && isValidType;
...
/***/ function(module, exports) {
	...
	const addItem = exports.addItem = (value, label, id, choiceId, groupId) => {
	  return {
	    type: 'ADD_ITEM',
	    value,
	    label,
	...
	const removeItem = exports.removeItem = (id, choiceId) => {
	  return {
	    type: 'REMOVE_ITEM',
	    id,
	    choiceId
	...
	const highlightItem = exports.highlightItem = (id, highlighted) => {
	  return {
	    type: 'HIGHLIGHT_ITEM',
	    id,
	    highlighted
	...
	const addChoice = exports.addChoice = (value, label, id, groupId, disabled) => {
	  return {
	    type: 'ADD_CHOICE',
	    value,
	    label,
	...
	const filterChoices = exports.filterChoices = results => {
	  return {
	    type: 'FILTER_CHOICES',
	    results
	  };
	...
	const activateChoices = exports.activateChoices = (active = true) => {
	  return {
	...
	const clearChoices = exports.clearChoices = () => {
	  return {
	    type: 'CLEAR_CHOICES'
	  };
	};

	const addGroup = exports.addGroup = (value, id, active, disabled) => {
	  return {
	    type: 'ADD_GROUP',
	    value,
	    id,
	...
	const clearAll = exports.clearAll = () => {
	  return {
	    type: 'CLEAR_ALL'
	  };
		};
...
/***/ function(module, exports) {
	 ...
	 */
	const capitalise = exports.capitalise = function (str) {
	 ...
	 * @return {Boolean}
	 */
	const getType = exports.getType = function (obj) {
	 ...
	 * @return {Boolean}
	 */
	const isType = exports.isType = function (type, obj) {
	 ...
	 */
	const extend = exports.extend = function () {
	  let extended = {};
	 ...
	 * @return
	 */
	const whichTransitionEvent = exports.whichTransitionEvent = function () {
	  var t,
	 ...
	 * @return
	 */
	const whichAnimationEvent = exports.whichAnimationEvent = function () {
	  var t,
	      el = document.createElement('fakeelement');
	 ...
	 */
	const getParentsUntil = exports.getParentsUntil = function (elem, parent, selector) {
	  var parents = [];
	  // Get matches
	...
	const wrap = exports.wrap = function (element, wrapper) {
	...
	const getSiblings = exports.getSiblings = function (elem) {
	  var siblings = [];
	 ...
	 */
	const findAncestor = exports.findAncestor = function (el, cls) {
	 ...
	 */
	const findAncestorByAttrName = exports.findAncestorByAttrName = function (el, attr) {
	  let target = el;
	 ...
	 */
	const debounce = exports.debounce = function (func, wait, immediate) {
	  var timeout;
	  return function () {
	    var context = this,
	        args = arguments;
	 ...
	 */
	const getElemDistance = exports.getElemDistance = function (el) {
	  var location = 0;
	  if (el.offsetParent) {
	    do {
	 ...
	 */
	const getElementOffset = exports.getElementOffset = function (el, offset) {
	  var elOffset = offset;
	 ...
	 */
	const getAdjacentEl = exports.getAdjacentEl = (startEl, className, direction = 1) => {
	 ...
	 */
	const getScrollPosition = exports.getScrollPosition = function (position) {
	  if (position === 'bottom') {
	 ...
	 * @return {Boolean}
	 */
	const isInView = exports.isInView = function (el, position, offset) {
	 ...
	 * @return {Boolean}
	 */
	const isScrolledIntoView = exports.isScrolledIntoView = (el, parent, direction = 1) => {
	  if (!el) return;
	 ...
	 */
	const stripHTML = exports.stripHTML = function (html) {
	 ...
	 * @return
	 */
	const addAnimation = exports.addAnimation = (el, animation) => {
	 ...
	 */
	const getRandomNumber = exports.getRandomNumber = function (min, max) {
	 ...
	 */
	const strToEl = exports.strToEl = function () {
	 ...
	 */
	const getWidthOfInput = exports.getWidthOfInput = input => {
	 ...
	 *                    0 for same location
	 */
	const sortByAlpha = exports.sortByAlpha = (a, b) => {
	 ...
	 *                    0 for same location
	 */
	const sortByScore = exports.sortByScore = (a, b) => {
	  return a.score - b.score;
	};
	 ...
	 */
	const triggerEvent = exports.triggerEvent = (element, type, customArgs = null) => {
